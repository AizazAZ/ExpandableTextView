...
public class ExpandableTextView extends FrameLayout implements
	...
	private boolean mMoreWasShown = false; // if more was shown, by default is
	// false
	...
	public void onClick(View view) {
		if (!mMoreWasShown /* || mButton.getVisibility() != View.VISIBLE */) {
			return;
		}
		...
		animation.setAnimationListener(new Animation.AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				...
				if (mCollapsed) {
					...
					mButton.setText(R.string.less);
				}
				ScreenUtils.expandViewTouchDelegate(mButton, 20, 20, 20, 20);
			}
	...
	// public void setText(CharSequence text, SparseBooleanArray
	// collapsedStatus,
	// int position) {
